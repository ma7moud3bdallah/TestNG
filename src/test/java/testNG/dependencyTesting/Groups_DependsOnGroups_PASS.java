...
public class Groups_DependsOnGroups_PASS
{
    ...
    {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//a[@class='oxd-main-menu-item'])[2]")));
        WebElement menuPIM = driver.findElement(By.xpath("(//a[@class='oxd-main-menu-item'])[2]"));
        Highlighter.highlightElement(driver, menuPIM);
        menuPIM.click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='oxd-grid-4 orangehrm-full-width-grid']//div[1]//div[1]//div[2]//div[1]//div[1]//input[1]")));
